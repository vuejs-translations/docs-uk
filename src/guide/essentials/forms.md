...
Якщо ви хочете, щоб пробіли у введених користувачами обрізалися автоматично з початку так з кінця, ви можете додати модифікатор `trim` до своїх введених даних, керованих `v-model`:
