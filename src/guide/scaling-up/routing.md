...
Vue добре підходить для розробки одно-сторінкових додатків. Для більшості SPA рекомендується використовувати офіційно підтримувану бібліотеку [Vue Router](https://github.com/vuejs/router). Для додаткової інформації перегляньте [документацію Vue Router](https://vue-router.netlify.app/).
