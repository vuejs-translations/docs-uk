...
- Використовуйте [`vue-tsc`](https://github.com/vuejs/language-tools/tree/master/packages/tsc) для виконання перевірки типів з командного рядка або для створення файлів `d.ts` для SFC.
